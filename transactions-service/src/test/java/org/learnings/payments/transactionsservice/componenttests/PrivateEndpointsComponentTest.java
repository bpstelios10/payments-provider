...
public class PrivateEndpointsComponentTest {
    ...
    void getActuatorLinks() throws Exception {
        mockMvc.perform(get("/transactions-service/private").accept(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk())
    ...
    void getActuatorMetrics() throws Exception {
        ...
        mockMvc.perform(get("/transactions-service/private/metrics"))
                .andExpect(status().isOk())
    ...
    void getActuatorConfigProps() throws Exception {
        mockMvc.perform(get("/transactions-service/private/configprops"))
                .andExpect(status().isOk())
    ...
    void getActuatorEnv() throws Exception {
        mockMvc.perform(get("/transactions-service/private/env"))
                .andExpect(status().isOk())
    ...
    void getActuatorHeapdump() throws Exception {
        mockMvc.perform(get("/transactions-service/private/heapdump"))
                .andExpect(status().isOk());
    }

    @Test
    void getActuatorHealth() throws Exception {
        mockMvc.perform(get("/transactions-service/private/health"))
                .andExpect(status().isOk())
    ...
    void getActuatorLivenessCheck() throws Exception {
        mockMvc.perform(get("/transactions-service/private/health/liveness"))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$['status']").value("UP"));
    }
    ...
    void getActuatorReadinessCheck() throws Exception {
        mockMvc.perform(get("/transactions-service/private/health/readiness"))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$['status']").value("UP"));
    }
}
