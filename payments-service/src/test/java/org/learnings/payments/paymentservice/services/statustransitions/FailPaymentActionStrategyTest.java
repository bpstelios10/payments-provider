...
class FailPaymentActionStrategyTest {

    private final FailPaymentActionStrategy strategy = new FailPaymentActionStrategy();
    ...
    void getNextState() {
        ...
        assertThat(nextState).isEqualTo(PaymentStatus.FAILED);
    }

    public static Stream<Arguments> supportsCasesProvider() {
        return Stream.of(
                Arguments.of(PaymentStatus.PROCESSING, PaymentStatusAction.FAIL, true),
                Arguments.of(PaymentStatus.FAILED, PaymentStatusAction.FAIL, false),
